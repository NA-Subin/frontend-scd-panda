...
const UpdateInvoice = (props) => {
  ...
  const totalIncomingDetail = transferMoneyDetail.filter(
    (trans) => trans.TicketNo === ticket.No && trans.Status !== "ยกเลิก",
  );
          ...
          >
            <Table
              ...
              sx={{
                ...
                width: openNavbar ? "1230px" : "1320px",
              }}
            >
              <TableHead>
                <TableRow>
                            ...
                            <>
                              ...
                              >
                                ...
                                >
                                  {formatThaiSlash(
                                    dayjs(
                                      report[row.uniqueRowId]?.DateReceive ||
                                        row.DateReceive,
                                      "DD/MM/YYYY",
                                    ),
                                  )}
                ...
                <TableBody>
                  {transfer.map((row, index) => (
                    <TableRow>
                      ...
                      <TableCell
                        sx={{ textAlign: "center", height: "30px", width: 170 }}
