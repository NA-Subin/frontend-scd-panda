...
> (ไม่ได้อยู่ใน `public/`) — **ถ้าผู้รับช่วงต่อไม่ได้เขียนโค้ดมาก่อน แนะนำให้อ่านไฟล์นี้แทน README**

> ⚠️ **repo นี้มีแค่โค้ด ไม่มีข้อมูลจริงของบริษัทอยู่เลย** ต้องมีไฟล์ข้อมูล (`.sql` backup หรือ Firebase
> export) จาก backend repo ส่งมอบมาแยกต่างหากด้วยเสมอ — ดูรายละเอียดที่ README ของ backend repo หรือหัวข้อ
> "ภาพรวมระบบ" ใน `DEPLOY_GUIDE.html`
